...
class Host:
    ...
    def __init__(self, host_id, backend=None):
        ...
        # Fidelity of EPR pair generated by host, defaults to 1
        self._fidelity = 1.0
    ...
    def fidelity(self):
        """
        Get fidelity of EPR pairs generated by current host
    ...
    def fidelity(self, fidelity):
        """
        Set the fidelity of the EPR pair generated by this host

        Args:
            fidelity (float): Fidelity of the EPR pair generated by this host
        """
        if not (isinstance(fidelity, int) or isinstance(fidelity, float)):
            raise Exception('Fidelity should be a number')
        elif fidelity > 1.0 or fidelity < 0.0:
            raise ValueError('Fidelity should be between 0 and 1')
        else:
    ...
    def heralding_probability(self):
        """
        Get heralding probability of the quantum storage associated with this host

        Returns:
            Heralding probability of this host's quantum storage (float)
        """
    ...
    def set_heralding_probability(self, heralding_probability):
        ...
        Args:
            heralding_probability (float): Probability that a received qubit is heralded
        """
    ...
    def send_epr(self, receiver_id, q_id=None, await_ack=False, no_ack=False, block=False, fidelity=None):
        """
        ...
        Args:
            ...
            fidelity (float): Fidelity of the generated EPR pair
        Returns:
    ...
    def add_epr(self, host_id, qubit, q_id=None, blocked=False, fidelity=1.0):
        """
        ...
        Args:
            ...
            fidelity(float): Fidelity of the EPR pair
        Returns:
