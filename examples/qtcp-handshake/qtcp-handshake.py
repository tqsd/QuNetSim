...
def handshake_receiver(host, sender_id):
    ...
    if qa_3_check == 0 and qb_4_check == 0:
        ...
        Logger.get_instance().log("Something went wrong.")
        return False
...
def main():
    ...
    host_alice.max_ack_wait = 15
    host_alice.delay = 0.2
    host_alice.start()

    host_bob = Host('Bob')
    host_bob.max_ack_wait = 15
    host_bob.delay = 0.2
